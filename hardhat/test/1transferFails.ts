...
describe("One of the two transaction from the batch fails", () => {
  before(async () => {
    ...
    TokenB = await ethers.getContractFactory("TokenC");
  ...
  describe("sending transaction", async () => {
    it("The not failed transaction should go through", async () => {
